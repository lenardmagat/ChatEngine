...
public class SendMessageDeclinedStrategy : IMessageStrategy
{
    public MessageType Target => MessageType.OfferDeclined;
    private readonly DbManager _db;
    private readonly IHasher _hasher;
    private readonly IMediator _mediator;
    private readonly ILogger<SendMessageDeclinedStrategy> _logger;

    public SendMessageDeclinedStrategy(IMediator mediator, DbManager db, IHasher hasher, ILogger<SendMessageDeclinedStrategy> logger)
    {
        _db = db;
        _hasher = hasher;
        _mediator = mediator;
    ...
    public async Task<Result<MessageResponseDTO>> MessageHandler(int UserId, SendMessage request, CancellationToken cancellation)
    {
        try
        {
            ...
            var newMessage = new ChatMessage
            {
                ...
                Type = MessageType.OfferDeclined,
        ...
        {
            _logger.LogError(ex, "Error occurred while handling SendMessageDeclinedStrategy.");
